...
# -- Global functions ----------------------------------------------------------
# ==============================================================================
CV_message = {"carla0":{"advice speed": 0, "time difference": 0, "navigation": "none"},"carla1":{"time_difference":0,"advice_speed":0,"navigation": "none"},"carla3":{"time_difference":0,"advice_speed":0,"navigation": "none"}}
...
class SpeedMention(object):
    def __init__(self, font, width, height):
        ...
        text_texture =self.font.render("Speed Over 40!",True,(255,255,255))
        self.surface.blit(text_texture,(20,1))
        self._render = False
